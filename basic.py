...
class Module(BaseModule):
    ...
    def copy(self):
        copy = Module(self.name, self.body_node, self.arg_names)
        copy.set_context(self.context)
        copy.set_pos(self.pos_start, self.pos_end)
        return copy
...
class Interpreter:
    ...
    def visit_ModuleDefNode(self, node, context):
        ...
        module_value = Module(module_name, body_node, arg_names).set_context(context).set_pos(node.pos_start, node.pos_end)
